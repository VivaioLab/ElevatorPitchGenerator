...
module.exports = function (app) {
  ...
  // send-mail
    ...
    app.route('/api/questions/link-pitch').put(pitchController.updatepitch);
    ...
    app.route('/api/questions/create-question').put(questionsController.updatequestions);
    app.route('/api/questions/create-question/:id').post(questionsController.getquestionbyID);
